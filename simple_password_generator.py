...
tk.Checkbutton(frame, text="Uppercase", variable=uppercase_var, bg="#f0f0f0", font=("Helvetica", 10)).grid(row=1, column=0, sticky="w", pady=2)

lowercase_var = tk.BooleanVar()
tk.Checkbutton(frame, text="Lowercase", variable=lowercase_var, bg="#f0f0f0", font=("Helvetica", 10)).grid(row=2, column=0, sticky="w", pady=2)

digits_var = tk.BooleanVar()
tk.Checkbutton(frame, text="Digits", variable=digits_var, bg="#f0f0f0", font=("Helvetica", 10)).grid(row=3, column=0, sticky="w", pady=2)

symbols_var = tk.BooleanVar()
tk.Checkbutton(frame, text="Symbols", variable=symbols_var, bg="#f0f0f0", font=("Helvetica", 10)).grid(row=4, column=0, sticky="w", pady=2)
